Feature: Claims
  ...
  Background:
    ...
    And the following claims exist:
  ...
  Scenario: Create a new Claim
    ...
    And I am on "/de/mein-konto/meine-forderungen.html"
    And I follow "New"
  ...
  Scenario: Create a new Claim for new Team
    ...
    When I am on "/de/mein-konto/meine-forderungen.html"
  ...
  Scenario: Creditor comments on a claim
    ...
    Then I should be on page "/de/mein-konto.html"
    And I follow "Meine Forderungen"
  ...
  Scenario: Debtor comments on a claim
    When I am logged in as "randy" "russel"
    Then I should be on page "/de/mein-konto.html"
    And I follow "Meine Verbindlichkeiten"
    And I click on "Detail" on the row containing "R2001"
